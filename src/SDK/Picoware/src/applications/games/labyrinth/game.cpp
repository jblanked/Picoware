...
#define WALL(h, y, x, l)                      \
    ...
    static const uint8_t player_10x10[100] = {
    ...
    static void player_render(Entity *self, Draw *draw, Game *game)
    {
        ...
        draw->text(Vector(100, 224), "labyrinth game demo", TFT_RED);
    }

    void player_spawn(Level *level)
    {
        // Create the player entity
        Entity *player = new Entity("Player", ENTITY_PLAYER, Vector(160, 130), Vector(10, 10), player_10x10, NULL, NULL, NULL, NULL, player_update, player_render, NULL, true, true);
    ...
    static void wall_render(Entity *self, Draw *draw, Game *game)
    {
        ...
        draw->fillRect(pos, size, TFT_BLACK);
    }
