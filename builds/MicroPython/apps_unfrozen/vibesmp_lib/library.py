# VibesMP path helpers, playlists, scanning, and library database.
...
class Library:
    ...
    def get_title(self, path):
        ...
        title = ""
        try:
            from vibesmp_lib.metadata import get_cached_title
    ...
    def load_track_metadata(self, path):
        ...
        md = {}
        try:
            from vibesmp_lib.metadata import get_meta_paths
    ...
    def extract_next_metadata(self):
        ...
        while self._metadata_queue_idx < len(self._metadata_queue):
            ...
            try:
                from vibesmp_lib.metadata import extract_metadata
