...
void picoware_lvgl_textbox_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind)
{
    (void)kind;
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
    mp_print_str(print, "TextBox(y=");
    ...
    mp_obj_print_helper(print, mp_obj_new_int(self->foreground_color_565), PRINT_REPR);
    mp_print_str(print, ", background_color=");
    mp_obj_print_helper(print, mp_obj_new_int(self->background_color_565), PRINT_REPR);
    mp_print_str(print, ", show_scrollbar=");
    mp_print_str(print, self->show_scrollbar ? "True" : "False");
    mp_print_str(print, ")");
}

// TextBox constructor
mp_obj_t picoware_lvgl_textbox_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args)
{
...
void picoware_lvgl_textbox_attr(mp_obj_t self_in, qstr attribute, mp_obj_t *destination)
{
    if (destination[0] == MP_OBJ_NULL)
    {
        ...
        {
        case MP_QSTR_text:
            destination[0] = picoware_lvgl_textbox_get_text(self_in);
            break;
        case MP_QSTR_text_height:
            destination[0] = picoware_lvgl_textbox_get_text_height(self_in);
            break;
    ...
    { // Store attributes
        ...
        {
        case MP_QSTR_text:
            picoware_lvgl_textbox_set_text(self_in, destination[1]);
            break;
        case MP_QSTR_current_line:
            picoware_lvgl_textbox_set_current_line(self_in, destination[1]);
            break;
        default:
            return; // Fail
        };
...
mp_obj_t picoware_lvgl_textbox_get_text(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
    if (self->textarea)
    {
...
mp_obj_t picoware_lvgl_textbox_get_text_height(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_clear(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_refresh(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_scroll_down(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_scroll_up(mp_obj_t self_in)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_set_current_line(mp_obj_t self_in, mp_obj_t line_obj)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_textbox_set_text(mp_obj_t self_in, mp_obj_t text_obj)
{
    picoware_lvgl_textbox_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
MP_DEFINE_CONST_OBJ_TYPE(
    ...
    print, picoware_lvgl_textbox_print,
    make_new, picoware_lvgl_textbox_make_new,
    attr, picoware_lvgl_textbox_attr,
