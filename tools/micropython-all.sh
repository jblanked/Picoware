...
export CMAKE_ARGS
make -j BOARD=RPI_PICO USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=512000 CFLAGS_EXTRA="-DPICOCALC"
...
# PicoCalc - Pico 2W 
make -j BOARD=RPI_PICO2_W USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=2048000 CFLAGS_EXTRA="-DPICOCALC -DPBUF_POOL_SIZE=10"
