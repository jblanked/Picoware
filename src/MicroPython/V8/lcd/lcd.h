/*
 * LCD Driver for the Marauder V8 (ESP32-C5, ILI9341 240x320 SPI).
 *
 * 8-bit RGB332 framebuffer expanded through a palette to RGB565 on swap, as on
 * the Cardputer.
 */
...
#define LCD_HEIGHT 320   // Vertical resolution
#define BITS_PER_PIXEL 8 // Number of image display bits of the display screen

#define LCD_BACKLIGHT_PIN 8        // LCD Backlight Pin
