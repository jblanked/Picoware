// original author: Waveshare Team, translated from the RP2350-Touch-LCD-1.69 demo (LCD_1in69.c/h)
// ST7789V2 driver: 240x280 IPS panel, portrait orientation
#pragma once
...
// The ST7789 controller has 240x320 of GRAM; the 280-line panel sits in the
// middle of it, so every window write is shifted down by this many rows.
#define LCD_Y_OFFSET 20

extern uint8_t framebuffer[LCD_WIDTH * LCD_HEIGHT]; // Framebuffer for 8-bit indexed color
