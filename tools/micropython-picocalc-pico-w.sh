...
# PicoCalc - Pico W
make -j BOARD=RPI_PICO_W USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=331776 CFLAGS_EXTRA="-DPICOCALC"
