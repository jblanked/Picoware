...
Attributes:
    ...
    BOARD_HAS_IR (bool): True if the board has an infrared transmitter, False otherwise.
    BOARD_HAS_IR_RX (bool): True if the board has an infrared receiver, False otherwise.
...
BOARD_HAS_IR = picoware_boards.BOARD_HAS_IR
BOARD_HAS_IR_RX = picoware_boards.BOARD_HAS_IR_RX
BOARD_HAS_KEYBOARD = picoware_boards.BOARD_HAS_KEYBOARD
