...
void picoware_lvgl_toggle_print(const mp_print_t *print, mp_obj_t self_in, mp_print_kind_t kind)
{
    (void)kind;
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
    mp_print_str(print, "Toggle(state=");
    mp_print_str(print, self->state ? "ON" : "OFF");
...
// Toggle constructor
mp_obj_t picoware_lvgl_toggle_make_new(const mp_obj_type_t *type, size_t n_args, size_t n_kw, const mp_obj_t *args)
{
...
// Toggle destructor
mp_obj_t picoware_lvgl_toggle_del(mp_obj_t self_in)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
    if (self->freed)
    {
...
void picoware_lvgl_toggle_attr(mp_obj_t self_in, qstr attribute, mp_obj_t *destination)
{
    if (destination[0] == MP_OBJ_NULL)
    {
        ...
        {
        case MP_QSTR_state:
            destination[0] = picoware_lvgl_toggle_get_state(self_in);
            break;
        case MP_QSTR_text:
            destination[0] = picoware_lvgl_toggle_get_text(self_in);
            break;
        case MP_QSTR___del__:
            destination[0] = MP_OBJ_FROM_PTR(&picoware_lvgl_toggle_del_obj);
            break;
        default:
            return; // Fail
        };
    ...
    else if (destination[1] != MP_OBJ_NULL)
    {
        ...
        {
        case MP_QSTR_state:
            picoware_lvgl_toggle_set_state(self_in, destination[1]);
            break;
        case MP_QSTR_text:
            picoware_lvgl_toggle_set_text(self_in, destination[1]);
            break;
        default:
            return; // Fail
        };
...
mp_obj_t picoware_lvgl_toggle_get_state(mp_obj_t self_in)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_toggle_set_state(mp_obj_t self_in, mp_obj_t value)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_toggle_get_text(mp_obj_t self_in)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
    if (self->label)
    {
...
mp_obj_t picoware_lvgl_toggle_set_text(mp_obj_t self_in, mp_obj_t value)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_toggle_clear(mp_obj_t self_in)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_toggle_draw(size_t n_args, const mp_obj_t *args)
{
...
mp_obj_t picoware_lvgl_toggle_toggle(mp_obj_t self_in)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
mp_obj_t picoware_lvgl_toggle_update(mp_obj_t self_in, mp_obj_t text_obj, mp_obj_t state_obj)
{
    picoware_lvgl_toggle_obj_t *self = MP_OBJ_TO_PTR(self_in);
...
MP_DEFINE_CONST_OBJ_TYPE(
    ...
    print, picoware_lvgl_toggle_print,
    make_new, picoware_lvgl_toggle_make_new,
    attr, picoware_lvgl_toggle_attr,
