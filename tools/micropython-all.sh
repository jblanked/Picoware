...
export CMAKE_ARGS
make -j BOARD=RPI_PICO USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=544768 CFLAGS_EXTRA="-DPICOCALC"
...
CMAKE_ARGS="-DPICOWARE_ENABLE_GHOULS=ON"
export CMAKE_ARGS

# PicoCalc - Pico 2W 
# Leave room for the native 2D engine; application assets remain on SD.
make -j BOARD=RPI_PICO2_W USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=1900544 CFLAGS_EXTRA="-DPICOCALC -DPBUF_POOL_SIZE=10"
