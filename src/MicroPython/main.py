def main():
    ...
    from picoware.system.boards import BOARD_ID, BOARD_CROWPANEL_10_1, BOARD_CARDPUTER, BOARD_WAVESHARE_2_06, BOARD_PANCAKE

    if BOARD_ID in (BOARD_CROWPANEL_10_1, BOARD_CARDPUTER, BOARD_WAVESHARE_2_06, BOARD_PANCAKE):
