...
static int map_key(SDL_Keycode key) {
    switch (key) {
    case SDLK_UP: return 0xB5;
    case SDLK_DOWN: return 0xB6;
    case SDLK_LEFT: return 0xB4;
    case SDLK_RIGHT: return 0xB7;
    case SDLK_ESCAPE: return 0xB1;
    case SDLK_BACKSPACE: return 8;
    case SDLK_RETURN:
    case SDLK_KP_ENTER: return 13;
    case SDLK_TAB: return 9;
    case SDLK_HOME: return 0xD2;
    case SDLK_DELETE: return 0xD4;
    case SDLK_END: return 0xD5;
    ...
    case SDLK_F10: return 0x90;
    default:
        if (key >= 0 && key < 128) return (int)key;
        return -1;
    }
}
...
static const char **glyph(char c) {
    ...
    switch (c) {
    case ' ': return space; case 'A': return A; case 'B': return B; case 'C': return C;
    ...
    case 'X': return X; case 'Y': return Y; case 'Z': return Z; case '0': return N0;
    case '1': return N1; case '2': return N2; case '3': return N3; case '4': return N4;
    case '5': return N5; case '6': return N6; case '7': return N7; case '8': return N8;
    case '9': return N9; case ':': return colon; case '-': return dash; case '.': return dot;
    case '/': return slash; case ',': return comma; case '+': return plus;
        ...
        while (SDL_PollEvent(&event)) {
            if (event.type == SDL_QUIT) {
                ...
                if (event.key.keysym.mod & KMOD_CTRL) {
                    int new_scale = 0;
                    if (event.key.keysym.sym == SDLK_1) new_scale = 1;
                    else if (event.key.keysym.sym == SDLK_2) new_scale = 2;
                    else if (event.key.keysym.sym == SDLK_3) new_scale = 3;
                    else if (event.key.keysym.sym == SDLK_4) new_scale = 4;
                    if (new_scale) {
                        scale = new_scale;
                ...
                if (code >= 0) append_key(input_path, code);
            }
        }
