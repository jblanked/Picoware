...
def _draw_toolbox(view_manager):
    ...
    for i in range(7):
        ...
        if i == s.sel_tb:
            ...
            _draw.text(Vector(25, _y), opts[i], s.c_fg)
    _draw.swap()
...
def _draw_thread(view_manager):
    ...
    _draw.text(Vector(5, 205), "MINOR DIAM: " + _min_str + " " + _u_d, s.c_fg)
    _draw.text(Vector(5, 225), "TOTAL INFD: " + _inf_str + " " + _u_d, s.c_fg)
    _draw.text(Vector(5, 245), "COMP ANGLE: 29.5 DEG", s.c_sec)
    _draw.swap()
