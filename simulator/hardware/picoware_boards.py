...
BOARD_HAS_WIFI = 1 if BOARD_ID in (BOARD_PICOCALC_PICOW, BOARD_PICOCALC_PICO_2W, BOARD_PICOCALC_PIMORONI_2W, BOARD_CARDPUTER, BOARD_WAVESHARE_2_06, BOARD_PANCAKE, BOARD_V8, BOARD_DESKTOP) else 0
