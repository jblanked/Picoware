...
# Enable picoware_boards module
CIRCUITPY_PICOWARE_BOARDS ?= 1

# Enable picoware_game module
CIRCUITPY_PICOWARE_GAME ?= 1

# Enable picoware_keyboard module
CIRCUITPY_PICOWARE_KEYBOARD ?= 1

# Enable picoware_lcd module
CIRCUITPY_PICOWARE_LCD ?= 1

# Enable picoware_psram module
CIRCUITPY_PICOWARE_PSRAM ?= 1

# Enable picoware_sd module
CIRCUITPY_PICOWARE_SD ?= 1

# Enable picoware_southbridge module
CIRCUITPY_PICOWARE_SOUTHBRIDGE ?= 1

# Enable picoware_vfs module
CIRCUITPY_PICOWARE_VFS ?= 1

# Enable auto_complete module
CIRCUITPY_AUTO_COMPLETE ?= 1

# Enable vector module
CIRCUITPY_VECTOR ?= 1
...
# Enable MicroPython scheduler for keyboard callbacks
CFLAGS += -DMICROPY_ENABLE_SCHEDULER=1
