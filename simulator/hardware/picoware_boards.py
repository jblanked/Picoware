...
BOARD_CARDPUTER = 9
BOARD_WAVESHARE_2_06_ESP32S3 = 10
...
if _name == "picocalc-pico":
    ...
    BOARD_ID = BOARD_WAVESHARE_2_06_ESP32S3
else:
...
BOARD_HAS_SD = 1
BOARD_HAS_TOUCH = 1 if BOARD_ID in (BOARD_WAVESHARE_1_28_RP2350, BOARD_WAVESHARE_1_43_RP2350, BOARD_WAVESHARE_3_49_RP2350, BOARD_CROWPANEL_10_1, BOARD_WAVESHARE_2_06_ESP32S3) else 0
BOARD_HAS_WIFI = 1 if BOARD_ID in (BOARD_PICOCALC_PICOW, BOARD_PICOCALC_PICO_2W, BOARD_WAVESHARE_2_06_ESP32S3) else 0
BOARD_HAS_AUDIO = 0 if BOARD_ID == BOARD_WAVESHARE_2_06_ESP32S3 else 1
