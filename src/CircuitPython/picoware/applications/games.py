    ...
    if button in (BUTTON_UP, BUTTON_LEFT):
        ...
        if selected_game and _app_loader:
            ...
            if view_manager.get_view(game_view_name) is None:
                ...
                print(
                    f"[Games]: Created view for app {selected_game} after {int(monotonic()) - start_time} ms"
                )
                view_manager.add(game_view)

            view_manager.switch_to(game_view_name)
            print(
                f'[Games]: Switched to view for app "{selected_game}" after {int(monotonic()) - start_time} ms'
            )
