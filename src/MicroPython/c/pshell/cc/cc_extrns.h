...
{"acosf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_acosf, 1},
    ...
    {"lcd_circle", 4, lib_defines, c_mp_lcd_circle, 0},
    {"lcd_fill", 1, lib_defines, c_mp_lcd_fill, 0},
    {"lcd_fill_circle", 4, lib_defines, c_mp_lcd_fill_circle, 0},
    {"lcd_fill_rectangle", 5, lib_defines, c_mp_lcd_fill_rectangle, 0},
    {"lcd_fill_round_rectangle", 6, lib_defines, c_mp_lcd_fill_round_rectangle, 0},
    {"lcd_fill_triangle", 7, lib_defines, c_mp_lcd_fill_triangle, 0},
    {"lcd_fill_triangle_alpha", 8, lib_defines, c_mp_lcd_fill_triangle_alpha, 0},
    {"lcd_line", 5, lib_defines, c_mp_lcd_line, 0},
    {"lcd_pixel", 3, lib_defines, c_mp_lcd_pixel, 0},
    {"lcd_rectangle", 5, lib_defines, c_mp_lcd_rectangle, 0},
    {"lcd_swap", 0, lib_defines, c_mp_lcd_swap, 0},
    {"lcd_text", 4, lib_defines, c_mp_lcd_text, 0},
    {"lcd_triangle", 7, lib_defines, c_mp_lcd_triangle, 0},
#endif
...
// clang-format off
    ...
    {"asinf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_asinf, 1},
    {"asinhf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_asinhf, 1},
    {"atan2f", 2 | (2 << 5) | (0b11 << 10), math_defines, atan2f, 1},
    {"atanf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_atanf, 1},
    {"atanhf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_atanhf, 1},
    {"atoi", 1, stdlib_defines, atoi, 0},
    {"calloc", 2, stdlib_defines, wrap_calloc, 0},
    ...
    {"cosf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_cosf, 1},
    {"coshf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_coshf, 1},
    ...
    {"sinf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_sinf, 1},
    {"sinhf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_sinhf, 1},
    ...
    {"storage_file_read", 3, lib_defines, storage_file_read, 0},
    {"storage_file_read_chunk", 4, lib_defines, storage_file_read_chunk, 0},
    {"storage_file_read_file_chunk", 3, lib_defines, storage_file_read_file_chunk, 0},
    {"storage_file_seek", 2, lib_defines, storage_file_seek, 0},
    {"storage_file_size", 1, lib_defines, storage_file_size, 0},
    ...
    {"tanf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_tanf, 1},
    {"tanhf", 1 | (1 << 5) | (1 << 10), math_defines, c_mp_tanhf, 1},
