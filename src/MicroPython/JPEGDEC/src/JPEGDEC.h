...
#ifndef __JPEGDEC__
#define __JPEGDEC__
#if defined(__MACH__) || defined(__LINUX__) || defined(__MCUXPRESSO) || defined(ESP_PLATFORM) || defined(_WIN64) || defined(CARDPUTER) || defined(PANCAKE) || defined(V8) || defined(WAVESHARE_2_06) || defined(FLIPPER_ZERO)
#include <stdlib.h>
#include <string.h>
#include <stdint.h>
#include <stdio.h>
