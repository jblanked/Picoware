...
#define MJS_TAG_MASK MAKE_TAG(1, 15)
  ...
  struct mjs
  {
    ...
    struct mbuf fast_locals;            /* Fast local variables (mjs_val_t array) */
    size_t fast_locals_frame_stack[16]; /* Stack of frame start indices */
    int fast_locals_frame_depth;        /* Current frame stack depth */
