...
esp_err_t pancake_i2c_bus_acquire(i2c_master_bus_handle_t *out_bus)
{
    ...
    if (s_bus == NULL)
    {
        i2c_master_bus_config_t cfg = {
            .i2c_port = PANCAKE_I2C_PORT,
            .sda_io_num = PANCAKE_I2C_SDA_GPIO,
            .scl_io_num = PANCAKE_I2C_SCL_GPIO,
...
esp_err_t pancake_i2c_add_device(uint16_t address, i2c_master_dev_handle_t *out_dev)
{
    ...
    esp_err_t err = pancake_i2c_bus_acquire(&bus);
    if (err != ESP_OK)
    {
        return err;
    }
    ...
    i2c_device_config_t dev_cfg = {
        ...
        .scl_speed_hz = PANCAKE_I2C_FREQ_HZ,
    };
