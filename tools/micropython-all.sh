...
# PicoCalc - Pico 2W 
make -j BOARD=RPI_PICO2_W USER_C_MODULES="$micropython_dir"/modules/PicoCalc/picoware_modules.cmake MICROPY_HW_FLASH_STORAGE_BYTES=2088960 CFLAGS_EXTRA="-DPICOCALC -DPBUF_POOL_SIZE=10"
