...
namespace Cube
{
    ...
    static const PROGMEM uint8_t linestoRender = 12; // lines to render.
    ...
    static const PROGMEM Line3d Lines[12] = {
        // 12 lines to render.
        // Front Face.
        {
            {-50, -50, 50}, {50, -50, 50}},
...
const PROGMEM View cubeView = View("Cube", Cube::cubeRun, Cube::cubeStart, Cube::cubeStop);
