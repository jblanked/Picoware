...
def start(view_manager) -> bool:
    ...
    radius = min(screen_size.x, screen_size.y) // 2 - view_manager.draw.scale_y(60)
    return True
...
def run(view_manager) -> None:
    ...
    # Draw center dot
    draw._fill_circle(circ_vec.x, circ_vec.y, draw.scale_x(4), TFT_WHITE)
    ...
    draw._line(
        line_vec_pos.x, line_vec_pos.y, line_vec_size.x, line_vec_size.y, TFT_GREEN
    )
    ...
    draw._line(
        line_vec_pos.x, line_vec_pos.y, line_vec_size.x, line_vec_size.y, TFT_RED
    )
    ...
    draw._text(text_vec.x, text_vec.y, date_str, TFT_ORANGE)
