...
BOARD_HAS_WIFI = 1 if BOARD_ID in (BOARD_PICOCALC_PICOW, BOARD_PICOCALC_PICO_2W, BOARD_WAVESHARE_2_06, BOARD_PANCAKE, BOARD_V8) else 0
BOARD_HAS_AUDIO = 0 if BOARD_ID in (BOARD_WAVESHARE_2_06, BOARD_PANCAKE, BOARD_V8) else 1
