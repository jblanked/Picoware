...
def start(view_manager) -> bool:
    ...
    global _desktop, _desktop_http, _desktop_picoware, _time, _desktop_time_updated, _has_tried
    ...
    if _desktop_http is None:
        ...
        _desktop_http = HTTP(view_manager.wifi)
...
def run(view_manager) -> None:
    ...
    global _desktop_time_updated, _has_tried
